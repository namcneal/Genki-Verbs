...
class Application(Frame):
    ...
    def fill_sidebar(self, sidebar_width):
        ...
        self.chapters_list = Listbox(self.sidebar,height=4,selectmode=EXTENDED)
        #PROB CAN DELETE
        ...
        self.aspect_label = Label(self.sidebar, text = "Select Verb Aspect(s):")
    
        self.aspect_label.place(x=sidebar_width/2, y=105, anchor="center")    

        self.aspect_list = Listbox(self.sidebar,height=4,selectmode=EXTENDED)
        ...
        self.form_label = Label(self.sidebar, text = "Select Verb Form(s):")
        self.form_label.place(x=sidebar_width/2, y=205, anchor="center")    

        self.form_list = Listbox(self.sidebar,height=4,selectmode=EXTENDED)
        ...
        self.polarity_label = Label(self.sidebar, text = "Select Polarity:")
        self.polarity_label.place(x=sidebar_width/4, y=305, anchor="center")  
        self.pos_checkbox = Checkbutton(self.sidebar, text="Pos.",onvalue="RGB", offvalue="L")
        self.neg_checkbox = Checkbutton(self.sidebar, text="Neg.",onvalue="RGB", offvalue="L")
        ...
        self.tense_label = Label(self.sidebar, text = "Select Tense:")
        self.tense_label.place(x=sidebar_width/4.5, y=330, anchor="center")  
        self.past_checkbox = Checkbutton(self.sidebar, text="Past",onvalue="RGB", offvalue="L")
        self.present_checkbox = Checkbutton(self.sidebar, text="Present",onvalue="RGB", offvalue="L")
        ...
        self.display_label = Label(self.sidebar, text = "Display:")
        self.display_label.place(x=sidebar_width/6, y=355, anchor="center")  
        self.kana_checkbox = Checkbutton(self.sidebar, text="Kana",onvalue="RGB", offvalue="L")
        self.kanji_checkbox = Checkbutton(self.sidebar, text="Kanji",onvalue="RGB", offvalue="L")
        ...
        self.type_label = Label(self.sidebar, text = "Select Type:")
        self.type_label.place(x=sidebar_width/5, y=380, anchor="center")  
        self.u_checkbox = Checkbutton(self.sidebar, text="U",onvalue="RGB", offvalue="L")
        self.ru_checkbox = Checkbutton(self.sidebar, text="Ru",onvalue="RGB", offvalue="L")
        self.irr_checkbox =  Checkbutton(self.sidebar, text="Irr.",onvalue="RGB", offvalue="L")
        ...
        self.number_label = Label(self.sidebar, text = "Number to Practice:")
        self.number_label.place(x=sidebar_width-145, y=415, anchor="center")

        self.num_user_entry = Entry(self.sidebar, width=5)
